from test_files import functions


def find_multiples(num, amount):
...
def repeating_print(strings, freqs):
    """takes in a list of strings and a list of frequences and
    returns a formatted string printing out each string at it's frequency"""
    """***YOUR CODE HERE***"""
